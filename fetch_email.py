...
def matches_keywords(email_text, keywords, user_email):  # Added user_email parameter
    if not keywords:
    ...
    # Store in MongoDB with user's email address
    collection.insert_one({
        "email_text": email_text, 
        "keywords": keyword_list,
        "user_email": user_email,  # Added user's email
        "timestamp": datetime.datetime.now()  # Added timestamp for better tracking
    })
                ...
                try:
                    ...
                    for response_part in msg_data:
                        if isinstance(response_part, tuple):
                            ...
                            if not matches_keywords(email_text, keywords, email_addr):  # Pass user_email
